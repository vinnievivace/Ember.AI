...
Unity Extension Framework providing tools for Metaverse / Blockchain / Extended Reality / AI experiences.

Include this package in any Unity project by adding the following to the package manifest:

`Packages/manifest.json`

`"com.emberai": "https://github.com/vinnievivace/Ember.AI.git"`
